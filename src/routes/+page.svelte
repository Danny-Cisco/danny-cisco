...
<section class="bg-gray-50 py-16">
	<div class="container mx-auto px-4">
		<h2 class="relative mb-4 inline-block text-3xl font-bold">Featured Projects</h2>
...
<section class="py-16">
	<div class="container mx-auto px-4 text-white">
		<h2 class="relative mb-6 inline-block text-3xl font-bold text-white/50">Danny Cisco</h2>
		<div class=" mb-6 h-1 w-full bg-gradient-to-r from-blue-600"></div>
		...
		<a
			href="/bio"
			class="mt-6 inline-block rounded-md bg-blue-600 px-6 py-2 font-medium text-white transition duration-300 hover:bg-blue-700"
		>
			Read Full Bio
		</a>
	</div>
